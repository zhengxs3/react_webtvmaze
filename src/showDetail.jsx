...
function ShowDetail() {
  ...
  if (!show) return <p style={{ padding: '2rem' }}>Loading...</p>;
  ...
  return (
    <>
      ...
      <div style={{ fontFamily: 'Arial, sans-serif' }}>
        ...
        {cast.length > 0 && (
          <div style={{ backgroundColor: '#d4faf8', padding: '1.5rem', borderRadius: '0', margin: '0' }}>
        ...
        {crew.length > 0 && (
          <div style={{ backgroundColor: '#d4dafa', padding: '1.5rem', borderRadius: '0', margin: '0' }}>
